...
public class OneUp extends Sprite
{
    ...
    public OneUp(LevelScene world, int x, int y)
    {
        sheet = Art.items;
        ...
        xPicO = 8;
        yPicO = 15;
        this.xPic = 2; // sets image to the third image in the itemsheet;
